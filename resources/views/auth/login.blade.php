...
<body class="bg-gray-50">
    ...
    <div class="flex flex-col md:flex-row min-h-screen">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="space-y-4 md:space-y-5">
                            ...
                            <div class="flex items-center justify-between text-sm">
                                <label class="flex items-center cursor-pointer">
                                    <input type="checkbox" name="remember" class="w-4 h-4 text-black border-gray-300 rounded focus:ring-black focus:ring-2">
                                    <span class="ml-2 text-gray-700">Ingat saya</span>
                                </label>
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}" class="text-black hover:text-gray-700 font-medium">
                                        Lupa password?
                                    </a>
                                @endif
                            </div>
        ...
        <!-- Right Section - Hero/Info (Fixed on Desktop) -->
        <div class="hidden md:block md:w-1/2 right-section bg-gradient-to-br from-black via-gray-900 to-black">
            <div class="flex flex-col items-center justify-center h-full p-12 text-white">
                ...
                <div class="mb-8 relative">
                    ...
                    <i class="fas fa-shield-alt text-8xl relative z-10 opacity-90"></i>
                </div>

                <!-- Main Content -->
                <div class="text-center max-w-lg space-y-6">
                    <h2 class="text-4xl font-bold leading-tight">
                        Hidden But <span class="text-transparent bg-clip-text bg-gradient-to-r from-gray-300 to-white">Loud</span>
                    </h2>
                    
                    <p class="text-lg text-gray-300 leading-relaxed">
                        Bergabunglah dengan komunitas eksklusif yang mengutamakan privasi, keamanan, dan kualitas premium.
                    </p>
                    ...
                    <div class="space-y-4 pt-6">
                        <div class="flex items-start gap-4 text-left">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-400">Data Anda terenkripsi dan terlindungi dengan teknologi terkini</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 text-left">
                            ...
                            <div>
                                <h3 class="font-semibold text-white mb-1">Akses Premium</h3>
                                <p class="text-sm text-gray-400">Nikmati fitur eksklusif dan layanan berkualitas tinggi</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 text-left">
                            ...
                            <div>
                                <h3 class="font-semibold text-white mb-1">Komunitas Eksklusif</h3>
                                <p class="text-sm text-gray-400">Terhubung dengan member terpilih dari seluruh dunia</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-12 pt-8 border-t border-white/10">
                    <p class="text-sm text-gray-400 italic">
                        "Privasi adalah hak, bukan privilege"
                    </p>
                </div>
            </div>
        </div>
