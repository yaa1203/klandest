...
<body class="bg-gray-50">
    ...
    <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <!-- Left Section - Register Form (Scrollable) -->
        ...
        <div class="hidden md:block md:w-1/2 right-section bg-gradient-to-br from-black via-gray-900 to-black">
            <div class="flex flex-col items-center justify-center h-full p-12 text-white">
                ...
                <div class="mb-8 relative mt-4">
                    ...
                    <i class="fas fa-user-plus text-8xl relative z-10 opacity-90"></i>
                </div>

                <!-- Main Content -->
                <div class="text-center max-w-lg space-y-6">
                    <h2 class="text-4xl font-bold leading-tight">
                        Mulai Perjalanan <span class="text-transparent bg-clip-text bg-gradient-to-r from-gray-300 to-white">Anda</span>
                    </h2>
                    
                    <p class="text-lg text-gray-300 leading-relaxed">
                        Bergabunglah dengan ribuan member yang telah mempercayai Klandest untuk pengalaman eksklusif mereka.
                    </p>
                    ...
                    <div class="space-y-4 pt-6">
                        <div class="flex items-start gap-4 text-left">
                            ...
                            <div>
                                <h3 class="font-semibold text-white mb-1">Gratis Selamanya</h3>
                                <p class="text-sm text-gray-400">Tidak ada biaya tersembunyi, akses penuh tanpa batasan</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 text-left">
                            ...
                            <div>
                                <h3 class="font-semibold text-white mb-1">Setup Instan</h3>
                                <p class="text-sm text-gray-400">Daftar dalam 30 detik dan langsung mulai bertransaksi</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 text-left">
                            ...
                            <div>
                                <h3 class="font-semibold text-white mb-1">Support 24/7</h3>
                                <p class="text-sm text-gray-400">Tim kami siap membantu Anda kapan saja</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-12 pt-8 border-t border-white/10">
                    <p class="text-sm text-gray-400 italic">
                        "Bergabung hari ini, nikmati manfaatnya selamanya"
                    </p>
                </div>
            </div>
        </div>
